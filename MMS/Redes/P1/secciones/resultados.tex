...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=1\textwidth,angle=90]{img/resultados/grado-targets.png}
...
\begin{figure}[t]
    ...
    \begin{tabular}{| l | r |} 
        ...
        \hline
        Número de nodos componente gigante (y \%) & 7,624 (1) \\
        \hline
        Número de aristas componente gigante (y \%) & 27,806 (1) \\
        \hline
    \end{tabular}
    }
...
\subsection{Gráficas de las diferentes medidas globales.}
