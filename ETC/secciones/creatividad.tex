...
(Me gustó la idea y la he querido desarrollar con el resto de ejercicios de la asignatura).
...
% Entregable 2
% Palabra al azar en google (no tiene por qué ser adjetivos) palabrasaleatorias.com
% Decir cómo se ha sacado (OBLIGATORIO)
% Sacar varias tuplas y ya luego ver cómo

% Un parrafillo o dos
% La tecnología es opcional (cnn, empotrado)
