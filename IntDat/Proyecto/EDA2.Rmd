...
R por defecto nos carga las variables Age, Year y Positive como numéricas y Survival
...
Y como estamos orientados a clasificación, vamos a convertir ... ?=?=?=?


#### Análisis univariable

ANALIZAR Nº POSITIVOS VS Nº NEGATIVOS
...
```{r}
# ggplot(haberman, aes(sample=Mpg)) + 
...
```{r}
cat("Displacement: ")
skewness(haberman$Displacement)
cat("Horse_power: ")
skewness(haberman$Horse_power)
cat("Weight: ")
skewness(haberman$Weight)
cat("Mpg: ")
skewness(haberman$Mpg)
```
