...
# fit2 <- fitdistr(table(haberman$Positive) %>% unique(), "exponential")
# 
...
Según el método utilizado la necesitad de normalidad puede ser o no necesaria.
...
Corrplot
```{r}
corrplot.mixed(cor(haberman), tl.pos="lt", upper="color", lower.col="black", title="Pearson", mar=c(0,0,1,0))
corrplot.mixed(cor(haberman, method="kendall"), tl.pos="lt", upper="color", lower.col="black", title="Kendall", mar=c(0,0,1,0))
```
