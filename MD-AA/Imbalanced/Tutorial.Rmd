...
Una visualización de los datos nos muestra que la clase positiva se encuentran agrupados en una sola zona central del espacio (no hay small disjuncts). Los gráficos nos hacen pensar en dos posibles hipótesis:

1. Por un lado, podemos pensar que la clase negativa se superpone sobre la positiva. Tendríamos puntos ruidosos y fronteras difusas, pero no small disjuncts.

2. Por otro, se puede considerar que la clase negativa no es un único clúster, sino 4 de ellos en zonas del espacio bastante cercanas, pero aún así separados. Con esta idea en mente, un método de undersampling o de eliminación de ruido que quite las franjas centrales de la clase negativa podría darnos unos muy buenos resultados en training, pero malos en test si realmente esos puntos son representativos.
...
En general mejores resultados para SMOTE, pero mayor variabilidad en specificity.
