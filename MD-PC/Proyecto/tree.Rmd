...
```{r}
trn_values <- read_csv("data/v9 - preprocessed_train.csv")
trn_labels <- read_csv("data/v9 - preprocessed_train_labels.csv")
tst_values  <- read_csv("data/v9 - preprocessed_test.csv")
