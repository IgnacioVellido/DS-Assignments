...
2. PARA SUBMISSION 2, Añadir todo lo geo1
...
# Cuidado que count_families está incluído
factores <- c(5:ncol(trn_values))
```
...
cv_resul <- evaluate_Weka_classifier(c45_tree, numFolds=10)
cv_resul
```
