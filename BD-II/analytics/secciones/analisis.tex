...
% ya que al haberse reducido el conjunto de datos con los algoritmos de filtrado de ruido y reducción de instancias.
% Qué pasa con HME ??
...
\begin{table}
    ...
    \multicolumn{1}{|c|}{}   & RUS  & NCNEdit  & No    & 0.594 \\ \cline{2-5} 
    \multicolumn{1}{|c|}{}   & RUS  & No       & No    & 0.594 \\ \hline
    \end{tabular}
